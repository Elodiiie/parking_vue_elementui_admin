...
export default {
  ...
  methods: {
    initChart() {
      ...
      this.$axios.get('http://localhost:8080/echarts/recordpaycount').then(function(resp) {
        _this.paycount = resp.data
      })
      ...
      this.$axios.get('http://localhost:8080/echarts/getSixMonths').then(function(resp) {
        ...
        _this.chartData1 = { entrancecount: _this.entrancecount, exitcount: _this.exitcount, farecount: _this.farecount, paycount: _this.paycount }
      })
      this.setOptions(this.chartData1)
    },
    setOptions({ entrancecount, exitcount, farecount, paycount } = {}) {
